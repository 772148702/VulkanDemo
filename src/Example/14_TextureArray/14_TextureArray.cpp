...
//     };
    ...
    void SetupCommandBuffers()
    {
        ...
        for (int32 i = 0; i < m_CommandBuffers.size(); ++i)
        {
            ...
            for (int32 meshIndex = 0; meshIndex < m_Model->meshes.size(); ++meshIndex)
            {
                ...
                vkCmdBindDescriptorSets(m_CommandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, m_Pipeline->pipelineLayout, 0, 1, &m_DescriptorSet, 0, dynamicOffsets);
    ...
    void CreateDescriptorSetLayout()
    {
        ...
        //COMBINED_IMAGE_SAMPLER, what is this meaning
    ...
    void CreateUniformBuffers()
    {
        ...
        m_ParamData.step = 4;
        m_ParamData.debug = 0;
        m_ParamBuffer = vk_demo::DVKBuffer::CreateBuffer(m_VulkanDevice,VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT,    
           VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
            sizeof(ParamBlock),
            &(m_ParamData));
        m_ParamBuffer->Map();
